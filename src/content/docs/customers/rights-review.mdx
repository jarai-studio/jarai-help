...
<VideoHelper src="/videos/customer-rights.mp4" title="Read the Rights Review and decide" duration="90 sec">

1. Open a production that's awaiting publish — the **Rights Review** screen lists any advisory warnings (copyright, likeness, privacy, attribution), per platform.
2. **Read each warning** — it tells you what JARAI's analysis flagged and why.
3. **Acknowledge** the ones you accept; deselect any platform you don't want to publish to.
4. **Approve** to publish (with the risks acknowledged on record), or **Reject**.
