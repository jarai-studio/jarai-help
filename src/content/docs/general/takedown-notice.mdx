...
<VideoHelper src="/videos/takedown.mp4" title="How to submit a takedown notice" duration="60 sec">
...
The fastest way is the takedown form (link will appear here once it ships). Until then, email [legal@jarai.studio](mailto:legal@jarai.studio) with the following:
